...
We can download the json file from [Microsoft 365 data connector ARM template](https://github.com/Azure/Azure-Sentinel/blob/master/Solutions/Microsoft%20365/Package/mainTemplate.json)
